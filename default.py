...
#####################################################################
config_ctrigger={}
config_ctrigger["AC"]={"use":"Y","mode":1,"st1high":100,"st1low":-2000,"bfsec":30,"afsec":60}
...
#                                    sec             min            min
cmeasure2={'offset':0,'measureperiod':60,'stateperiod':1,'rawperiod':1, # 테스트를 위해 확 줄여두었음
